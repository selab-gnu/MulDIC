...
class MAIN:
    ...
    def run(self):
        ...
        # ### 테스트를 위해 ###
        #train_text = train_text[0:1000]
        #test_text = test_text[0:250]
        #train_code = train_code[0:1000]
        #test_code = test_code[0:250]

        #print('테스트용 train_text len: {}'.format(len(train_text)))
        #print("=========================")
        #print('테스트용 test_text len: {}'.format(len(test_text)))
        #print("=========================")
        #print('테스트용 train_code len: {}'.format(len(train_code)))
        #print("=========================")
        #print('테스트용 test_code len: {}'.format(len(test_code)))
        #print("=========================")
        # exit()
        ...
        if embedding_true:
            ...
            loaded_data = np.load('src/Embedded_data/embedded_data-4Proj-multimodal_TIC-1.npz')
    ...
    def _readFile(self, project):
        ...
        X_code_train = pd.concat([df_train_1['code'], df_train_2['code'], df_train_3['code'], df_train_5['code'], 
                                  df_train_7['code'], df_train_8['code'], df_train_9['code']], axis=0)
        X_code_test = pd.concat([df_test_1['code'], df_test_2['code'], df_test_3['code'], df_test_5['code'], 
                                  df_test_7['code'], df_test_8['code'], df_test_9['code']], axis=0)
        ...
        trainset = torchvision.datasets.ImageFolder(root='multimodal_BothCodeImage_dataset//train_data_4Proj',
                                                    transform=trans)
        testset = torchvision.datasets.ImageFolder(root='multimodal_BothCodeImage_dataset//test_data_4Proj',
                                                    transform=trans)
        train_img = trainset
        test_img = testset
